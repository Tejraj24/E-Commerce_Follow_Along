...
const BiggestSalesSection = () => {
  const [activeGender, setActiveGender] = useState('women');
  const [activeRange, setActiveRange] = useState(dropsData[activeGender].priceRanges[0].id);
  const [sliderKey, setSliderKey] = useState(`sales-${activeGender}-${activeRange}`);
  ...
  useEffect(() => {
    setSliderKey(`sales-${activeGender}-${activeRange}`);
  ...
  return (
    <section className="main__catalog catalog-main py-16 bg-white">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 mt-3 max-w-3xl">
                Discover the biggest discounts and best deals from our partner stores.
              </p>
            </div>
...
export default BiggestSalesSection;
